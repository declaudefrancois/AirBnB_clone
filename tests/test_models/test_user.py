...
class TestUser(TestCase):
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(obj.email, obj_dict["email"])
        self.assertEqual(obj.first_name, obj_dict["first_name"])
        self.assertEqual(obj.last_name, obj_dict["last_name"])
        self.assertEqual(obj.password, obj_dict["password"])
